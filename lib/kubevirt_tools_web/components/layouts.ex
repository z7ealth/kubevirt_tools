defmodule KubevirtToolsWeb.Layouts do
  ...
  def app(assigns) do
    ...
    <div class="flex min-h-dvh flex-col">
      <header class="navbar shrink-0 border-b border-base-300/60 bg-base-100/90 backdrop-blur-md px-4 sm:px-6 lg:px-8">
        <div class="flex-1">
      ...
      <main class="flex-1 min-w-0 space-y-4 px-4 py-10 sm:px-8 lg:px-14 overflow-x-hidden">
      ...
      <footer class="shrink-0 border-t border-base-300/60 bg-base-100/85 py-5 text-center">
        <a
          ...
          class="inline-flex items-center justify-center gap-2 text-sm text-base-content/65 transition-colors hover:text-primary"
          target="_blank"
        ...
        >
          ...
          <span class="font-medium">z7ealth</span>
        </a>
      </footer>
    </div>
